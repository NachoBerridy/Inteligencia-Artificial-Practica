...
class MLP:
    ...
    def __init__(self, neuronas_ocultas = 100, neuronas_entrada = 2, numero_clases = 3):
...
# (https://cs231n.github.io/neural-networks-case-study/)
    ...
    def ejecutar_adelante(self, x, pesos):
    ...
    def clasificar(self, x, pesos):
        ...
        resultados_feed_forward = self.ejecutar_adelante(x, pesos)
    ...
    def train(self, x, t, pesos, learning_rate, epochs, x_validacion, t_validacion):
        ...
        for i in range(epochs):
            ...
            resultados_feed_forward = self.ejecutar_adelante(x, pesos)
            y_validacion = self.ejecutar_adelante(x_validacion, pesos)['y']
            ...
            # Actualizamos la estructura de pesosrue)   # Ajuste para b2
    ...
    def iniciar(self, numero_clases, numero_ejemplos, graficar_datos):
        # Generamos datos
        ...
        LEARNING_RATE=1
        EPOCHS=30000
        self.pesos = self.train(x, t, self.pesos, LEARNING_RATE, EPOCHS, x_validacion, t_validacion)

    """pesos = iniciar(numero_clases=3, numero_ejemplos=300, graficar_datos=False)


    x_test, t_test = generar_datos_clasificacion(cantidad_ejemplos=300, cantidad_clases=3)
    test_scores = clasificar(x_test, pesos)

    presicion, recall, f1 = accuracy(t_test, test_scores, 3)
